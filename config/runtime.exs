...
#
#     PHX_SERVER=true bin/authbot start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :authbot, AuthbotWeb.Endpoint, server: true
end

if config_env() == :prod do
  database_url =
    System.get_env("AUTHBOT_DATABASE_URL") ||
      raise """
      environment variable AUTHBOT_DATABASE_URL is missing.
  ...
  config :authbot, Authbot.Repo,
    # ssl: true,
    url: database_url,
    pool_size: String.to_integer(System.get_env("AUTHBOT_POOL_SIZE") || "10"),
